...
func Load() (*Config, error) {
	...
	cfg := &Config{
		...
		DBDSN:               GetEnv("DB_DSN", "host=localhost user=postgres password=postgres dbname=productService port=5432 sslmode=disable TimeZone=UTC"),
		...
		// Service
		ServiceName:   GetEnv("SERVICE_NAME", "produc-service"),
